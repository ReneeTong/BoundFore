...
<html>
    ...
    <body>
        ...
        <div class="header-container">
            <img src="/images/city/lithuania_city.jpg" alt="">
            <div id="title">
                <h2>リトアニア</h2>
                <h3>Lithuania</h3>
            </div>
        ...
        <div class="body-container">
            <div class="text-container">
                ...
                <p>
                    <img src="/images/charts/lithuania_demographic.png" alt="">
                    （引用：<a href="Population: demographic situation, languages and religions | Eurydice (europa.eu)">Population: demographic situation, languages and religions | Eurydice (europa.eu)</a>）
                </p>
            </div>
            ...
            <div class="text-container">
                ...
                <p>
                    ...
                    <br>過去にナチス・ドイツやソ連に支配を受けていましたが、1990年に独立を回復しました。ちなみに現在のリトアニア憲法は5番目の憲法です。
                </p>
            </div>
            ...
            <div class="text-container">
                ...
                <p>
                    ...
                    <br>治安はとても安全です。裏道などには落書きがあるものの、カフェで荷物を放置しても大丈夫です。夜中も大通りなら一人で歩いていても危険を感じることはないです。
            ...
            <div class="text-container">
                ...
                <p>
                    ...
                    <br>独立記念日のパレードがあるのですが、これは1918年2月16日にロシアから独立した日、リトアニア評議会がリトアニア独立宣言書に署名した日です。この独立宣言書の原本は行方不明になっていたのですが2017年にドイツに保管されていることが分かりました。
                    <br>音楽も盛んでヴィリニュスフェスティバル、クリストファー・サマー・フェスティバル、カウナス・ジャズなど幅広い音楽の分野での国際的なイベントが主催されています。
                    <br>また、カウナスは杉原千畝がナチス・ドイツによって迫害されていたユダヤ人にビザを発行した場所です。「命のビザ」とも呼ばれ、約6500人を救ったと言われています。
                </p>
            </div>

            <div class="text-container">
                <h3>- Access from airport</h3>
                <p>
                    トロリーバスでの移動が一般的です。
                </p>
            </div>
            ...
            <div class="text-container">
                ...
                <p>
                    ...
                    <br>全ての会社でプリペイドシステムが導入されています。Omnitelは全国をカバーしているものの３GやLTEでトラブルが起こる恐れがあります。カードはガソリンスタンドやスーパーなどで簡単に購入できます。
                </p>
            </div>
            ...
            <div class="text-container">
                ...
                <p>
                    ...
                    <br>人文科、社会科学、物理、生物医学、テクノロジーの分野で学部と大学院の研究が行われています。
                    <br> <a href="Vilniaus universitetas (vu.lt)">Vilniaus universitetas (vu.lt)</a>
                </p>
            </div>
